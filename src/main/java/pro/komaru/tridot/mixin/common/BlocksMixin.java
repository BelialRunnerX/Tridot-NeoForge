...
// PORT NOTE: FlowerBlock's constructor takes (Holder<MobEffect>, float, Properties) and flowerPot(Block) lost its
// FeatureFlag varargs in 1.21; the torchflower light tweaks are otherwise unchanged.
@Mixin(Blocks.class)
