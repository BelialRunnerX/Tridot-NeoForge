...
// PORT NOTE: Components are (de)serialized with ComponentSerialization.TRUSTED_STREAM_CODEC, which needs a
// RegistryFriendlyByteBuf, so the operation encode/decode methods now take that buffer type.
