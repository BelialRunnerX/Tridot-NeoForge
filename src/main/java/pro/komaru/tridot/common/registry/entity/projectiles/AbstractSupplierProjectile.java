...
public abstract class AbstractSupplierProjectile extends AbstractProjectile implements ItemSupplier{
    ...
    public AbstractSupplierProjectile(EntityType<? extends AbstractArrow> pEntityType, Level worldIn, LivingEntity thrower, ItemStack thrownStackIn){
        ...
        // PORT NOTE: EnchantmentHelper.getLoyalty was removed; the level is read from the stack's enchantments component.
    ...
    public void onHitEntity(EntityHitResult result){
        ...
        if(shooter instanceof LivingEntity thrower && !this.returnToPlayer){
            ...
            if(isVelocityBased()){
                ...
                // PORT NOTE: EnchantmentHelper.getDamageBonus(stack, MobType) is gone (MobType was removed); the
                // weapon's damage enchantments are evaluated against the actual target with modifyDamage instead.
