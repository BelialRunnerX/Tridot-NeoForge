...
public class ConfigurableBowItem extends BowItem{
    ...
    /**
     * PORT NOTE: Power, Punch, Flame and Piercing are enchantment <i>effects</i> in 1.21 and only apply when the arrow
     * knows the weapon it was fired from. This links the arrow to the weapon and runs the spawn-time effects (Flame),
     * replacing the manual setBaseDamage/setKnockback/setSecondsOnFire bonuses of the 1.20.1 code.
     */
