...
public abstract class AbstractBoss extends MultiAttackMob implements Enemy, BossEntity, Allied{
    ...
    // PORT NOTE: canBreatheUnderwater() is final in 1.21 (driven by the can_breathe_under_water entity tag); never
    // losing air reproduces the old override for every boss without needing dependents to tag their entity types.
    @Override
    ...
    // PORT NOTE: NeoForge's onAddedToWorld hook was replaced by vanilla's onAddedToLevel.
    @Override
