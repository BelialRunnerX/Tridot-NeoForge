...
public class Utils {
    ...
    public static class Hit {
        ...
        // PORT NOTE: EnchantmentHelper.getSweepingDamageRatio/getDamageBonus are gone in 1.21. Sweeping is now the
        // SWEEPING_DAMAGE_RATIO attribute and per-target damage bonuses are applied by EnchantmentHelper.modifyDamage.
            ...
            for (Entity entity : entities) {
                if (entity instanceof LivingEntity enemy) {
                    if (!enemy.equals(player)) {
                        ...
                        // PORT NOTE: enchantment levels are read by ResourceKey now (see EnchantmentsRegistry.getLevel).
    ...
    public static class Items {
        ...
        // PORT NOTE: loot tables are looked up through the reloadable registries by ResourceKey in 1.21.
        ...
        // PORT NOTE: MobEffectInstance takes a Holder<MobEffect> in 1.21.
        ...
        // PORT NOTE: FriendlyByteBuf.readRegistryId/writeRegistryId were Forge additions; the numeric registry id is
        // written through the registry's holder id map instead (same wire size as before).
        ...
        /**
         * PORT NOTE: enchantments are datapack entries in 1.21 and cannot be resolved without a registry access, so
         * these helpers deal in {@link ResourceKey}s. Use {@link #deserializeEnchantment(JsonObject, HolderLookup.Provider)}
         * or {@link EnchantmentsRegistry#holder} when an actual {@link Holder} is required.
         */
    ...
    public static class Entities {
         ...
         * PORT NOTE: LivingAttackEvent was folded into LivingIncomingDamageEvent in NeoForge 1.21.
         *
