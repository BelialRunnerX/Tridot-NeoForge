...
public class GenericParticle extends TextureSheetParticle{
    ...
    // PORT NOTE: Particle.shouldCull() no longer exists in 1.21 (particles are always frustum-culled by the engine);
    // the flag is kept on the API so behaviours/builders can still query it.
    public boolean shouldCull(){
        return shouldCull;
    }
