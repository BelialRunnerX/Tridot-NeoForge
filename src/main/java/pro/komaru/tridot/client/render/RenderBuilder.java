...
public class RenderBuilder{
    ...
    // PORT NOTE: 1.21 VertexConsumer: addVertex/setColor/setUv/setLight/setNormal/setOverlay and no endVertex; the
    // vertex is committed by the next addVertex (or on build). Elements are VertexFormatElement.* constants and the
    // old ELEMENT_PADDING no longer exists (UV1 is the overlay).
    static{
